...
if (isset($collection)) {$chapterprefix = 'zechariah';}
if (!isset($collection)) {include 'bookhead.php';}
?>
<span id="<?php echo $chapterprefix; ?>1"></span><h3 id="zechariah">Zechariah</h3><!--1t38b-->
...
<span id="<?php echo $chapterprefix; ?>2"></span>2:1 I lifted up mine eyes again, and looked, and behold a man with a measuring line in his hand.
...
<span id="<?php echo $chapterprefix; ?>3"></span>3:1 And he shewed me Joshua the high priest standing before the angel of the LORD, and Satan standing at his right hand to resist him.
...
<span id="<?php echo $chapterprefix; ?>4"></span>4:1 And the angel that talked with me came again, and waked me, as a man that is wakened out of his sleep.
...
<span id="<?php echo $chapterprefix; ?>5"></span>5:1 Then I turned, and lifted up mine eyes, and looked, and behold a flying roll.
...
<span id="<?php echo $chapterprefix; ?>6"></span>6:1 And I turned, and lifted up mine eyes, and looked, and, behold, there came four chariots out from between two mountains; and the mountains were mountains of brass.
...
<span id="<?php echo $chapterprefix; ?>8"></span>8:1 Again the word of the LORD of hosts came to me, saying, 8:2 Thus saith the LORD of hosts; I was jealous for Zion with great jealousy, and I was jealous for her with great fury.
...
<span id="<?php echo $chapterprefix; ?>9"></span>9:1 The burden of the word of the LORD in the land of Hadrach, and Damascus shall be the rest thereof: when the eyes of man, as of all the tribes of Israel, shall be toward the LORD.
...
<span id="<?php echo $chapterprefix; ?>10"></span>10:1 Ask ye of the LORD rain in the time of the latter rain; so the LORD shall make bright clouds, and give them showers of rain, to every one grass in the field.
...
<span id="<?php echo $chapterprefix; ?>11"></span>11:1 Open thy doors, O Lebanon, that the fire may devour thy cedars.
...
11:6 For I will no more pity the inhabitants of the land, saith the LORD: but, lo, I will deliver the men every one into his neighbours hand, and into the hand of his king: and they shall smite the land, and out of their hand I will not deliver them.
...
<span id="<?php echo $chapterprefix; ?>12"></span>12:1 The burden of the word of the LORD for Israel, saith the LORD, which stretcheth forth the heavens, and layeth the foundation of the earth, and formeth the spirit of man within him.
...
<span id="<?php echo $chapterprefix; ?>13"></span>13:1 In that day there shall be a fountain opened to the house of David and to the inhabitants of Jerusalem for sin and for uncleanness.
...
<span id="<?php echo $chapterprefix; ?>14"></span>14:1 Behold, the day of the LORD cometh, and thy spoil shall be divided in the midst of thee.
