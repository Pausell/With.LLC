...
$title = 'Jonah';
$description = 'Jonah';
if (isset($collection)) {$chapterprefix = 'jonah';}
if (!isset($collection)) {include 'bookhead.php';}
?>
<span id="<?php echo $chapterprefix; ?>1"></span><h3 id="jonah">Jonah</h3><!--1t32b-->
...
<span id="<?php echo $chapterprefix; ?>2"></span>2:1 Then Jonah prayed unto the LORD his God out of the fish's belly, 2:2 And said, I cried by reason of mine affliction unto the LORD, and he heard me; out of the belly of hell cried I, and thou heardest my voice.
...
<span id="<?php echo $chapterprefix; ?>3"></span>3:1 And the word of the LORD came unto Jonah the second time, saying, 3:2 Arise, go unto Nineveh, that great city, and preach unto it the preaching that I bid thee.
...
<span id="<?php echo $chapterprefix; ?>4"></span>4:1 But it displeased Jonah exceedingly, and he was very angry.
