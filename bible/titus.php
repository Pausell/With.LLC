<?php
$title = 'Titus';
$description = 'The Epistle of Paul the Apostle to Titus';
if (isset($collection)) {$chapterprefix = 'titus';}
if (!isset($collection)) {include 'bookhead.php';}
?>
<span id="<?php echo $chapterprefix; ?>1"></span><h3 id="titus">The Epistle of Paul the Apostle to Titus</h3><!--2t17b-->
...
<span id="<?php echo $chapterprefix; ?>2"></span>2:1 But speak thou the things which become sound doctrine: 2:2 That the aged men be sober, grave, temperate, sound in faith, in charity, in patience.
...
<span id="<?php echo $chapterprefix; ?>3"></span>3:1 Put them in mind to be subject to principalities and powers, to obey magistrates, to be ready to every good work, 3:2 To speak evil of no man, to be no brawlers, but gentle, shewing all meekness unto all men.
