...
?>
<span id="1<?= $book ?>"></span><h2 id="titus">The Epistle of Paul the Apostle to Titus</h2><!--2t17b-->
...
<span id="2<?= $book ?>"></span>2:1 But speak thou the things which become sound doctrine: 2:2 That the aged men be sober, grave, temperate, sound in faith, in charity, in patience.
...
<span id="3<?= $book ?>"></span>3:1 Put them in mind to be subject to principalities and powers, to obey magistrates, to be ready to every good work, 3:2 To speak evil of no man, to be no brawlers, but gentle, shewing all meekness unto all men.
