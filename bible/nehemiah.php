<?php
$title = 'Nehemiah';
$description = 'The Book of Nehemiah';
if (!isset($include)) {
 include ('aa-beginning.php');
}
?>
<span id="1<?= $book ?>"></span><h2 id="nehemiah">The Book of Nehemiah</h2><!--1t16b-->
...
<span id="2<?= $book ?>"></span>2:1 And it came to pass in the month Nisan, in the twentieth year of Artaxerxes the king, that wine was before him: and I took up the wine, and gave it unto the king. Now I had not been beforetime sad in his presence.
...
<span id="3<?= $book ?>"></span>3:1 Then Eliashib the high priest rose up with his brethren the priests, and they builded the sheep gate; they sanctified it, and set up the doors of it; even unto the tower of Meah they sanctified it, unto the tower of Hananeel.
...
<span id="4<?= $book ?>"></span>4:1 But it came to pass, that when Sanballat heard that we builded the wall, he was wroth, and took great indignation, and mocked the Jews.
...
<span id="5<?= $book ?>"></span>5:1 And there was a great cry of the people and of their wives against their brethren the Jews.
...
<span id="7<?= $book ?>"></span>7:1 Now it came to pass, when the wall was built, and I had set up the doors, and the porters and the singers and the Levites were appointed, 7:2 That I gave my brother Hanani, and Hananiah the ruler of the palace, charge over Jerusalem: for he was a faithful man, and feared God above many.
...
<span id="8<?= $book ?>"></span>8:1 And all the people gathered themselves together as one man into the street that was before the water gate; and they spake unto Ezra the scribe to bring the book of the law of Moses, which the LORD had commanded to Israel.
...
<span id="9<?= $book ?>"></span>9:1 Now in the twenty and fourth day of this month the children of Israel were assembled with fasting, and with sackclothes, and earth upon them.
...
<span id="11<?= $book ?>"></span>11:1 And the rulers of the people dwelt at Jerusalem: the rest of the people also cast lots, to bring one of ten to dwell in Jerusalem the holy city, and nine parts to dwell in other cities.
