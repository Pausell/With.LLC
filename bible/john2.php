<?php
$title = '2 John';
$description = 'The Second Epistle General of John';
if (isset($collection)) {$chapterprefix = 'secondjohn';}
if (!isset($collection)) {include 'bookhead.php';}
?>
<span id="<?php echo $chapterprefix; ?>1"></span><h3 id="john2">The Second Epistle General of John</h3><!--2t24b-->
