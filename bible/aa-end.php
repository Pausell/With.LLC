...
tableOfContents.innerHTML = `<svg width="100%" height="100%" class="black white" width="260" height="261" viewBox="0 0 260 261" fill="none" xmlns="http://www.w3.org/2000/svg">
